...
test("historical mechanics footage needs explicit continuity review",()=>{
  const base={
    id:"historical",
    status:EVIDENCE_STATUS.ACCEPTED,
  ...
  assert.equal(canPromoteEvidence({...base,patchContinuityReviewed:true},"projectile.persistsAfterSourceDeath").promotable,true);
});
